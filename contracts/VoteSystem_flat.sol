...
contract VoteSystem {
    ...
    /**
     * Event for Voting period extending
    ...
    constructor(uint256 openingTimestamp, uint256 closingTimestamp, string[] memory proposalNames) payable {
        // deposit reward for voter giveaway.
        require(msg.value == reward, "Need to deposit 0.1 ether to winner");
    ...
    function finalize() public onlyOwner {
        ...
        // give the lucky voter the promised eth.
